 L.Control.Sidebar = L.Control.extend({
    ...
    open: function(id) {
        ...
        var mapControls = this.options.mapControlOption;
        var notControl = true;
        for (var i = mapControls.length - 1; i >= 0; i--) {
            if (id == mapControls[i]){
                notControl = false;
            }
        };
        ...
        if(notControl){
            ...
            for (i = this._tabitems.length - 1; i >= 0; i--) {
                ...
                if (child.firstChild.dataset.tab == '#' + id)
                    L.DomUtil.addClass(child, 'active');
                else if (L.DomUtil.hasClass(child, 'active'))
                    L.DomUtil.removeClass(child, 'active');
            }
    ...
    _onClick: function(e) {
        ...
        if (L.DomUtil.hasClass(this, 'active'))
            ...
            this._sidebar.open(this.firstChild.dataset.tab.slice(1));
